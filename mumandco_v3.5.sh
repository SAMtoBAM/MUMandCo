...
cat ${prefix}.SVs_all.notransloc ${prefix}.SVs_all.translocwithborder | sort -k1,1 -k3V >> ${prefix}.SVs_all.tsv
...
cat ${prefix}.SVs_all.withfragment.notransloc ${prefix}.SVs_all.withfragment.translocwithborder | sort -k1,1 -k3V >> ${prefix}.SVs_all.withfragment.tsv
